...
// <e> ANT_CHANNEL_CONFIG_ENABLED  - ant_channel_config - ANT common channel configuration
...
// <e> ANT_ENCRYPT_CONFIG_ENABLED  - ant_encrypt_config - Cryptographic ANT stack configuration
